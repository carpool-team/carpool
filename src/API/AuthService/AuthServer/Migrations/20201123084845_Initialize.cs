...
namespace AuthServer.Migrations
{
	public partial class Initialize : Migration
	{
		protected override void Up(MigrationBuilder migrationBuilder)
		{
			...
			migrationBuilder.CreateTable("RefreshToken",
				table => new
				{
					AuthUserId = table.Column<string>("nvarchar(450)", nullable: false),
					Id = table.Column<int>("int", nullable: false)
						.Annotation("SqlServer:Identity", "1, 1"),
					Token = table.Column<string>("nvarchar(max)", nullable: true),
					Expires = table.Column<DateTime>("datetime2", nullable: false),
					Created = table.Column<DateTime>("datetime2", nullable: false),
					Revoked = table.Column<DateTime>("datetime2", nullable: true)
				},
				constraints: table =>
				{
					table.PrimaryKey("PK_RefreshToken", x => new {x.AuthUserId, x.Id});
					table.ForeignKey("FK_RefreshToken_AspNetUsers_AuthUserId",
						x => x.AuthUserId,
						"AspNetUsers",
						"Id",
						onDelete: ReferentialAction.Cascade);
